...
class EducationMob extends StatefulWidget {
  const EducationMob({Key? key}) : super(key: key);

  @override
  State<EducationMob> createState() => _EducationMobState();
}

class _EducationMobState extends State<EducationMob> {
  @override
                        ...
                        children: [
                          RichText(
                            text: TextSpan(
                              ...
                              //     text: ' - ${educationList[data].institute}',
                              //     style: GoogleFonts.roboto(
                              //         color: AppColors.neonColor, fontSize: 18),
                              //   )
                              // ],
                            ),
                          ),
